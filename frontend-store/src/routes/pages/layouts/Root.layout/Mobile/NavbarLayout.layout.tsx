...
import { IconPerson, IconShoppingCart } from "~/routes/pages/common/Icons";

import { clsx as cx } from "clsx";
import { Link, LinkProps, useRouter } from "@tanstack/react-router";

import { MobileSidebar } from "~/routes/pages/layouts/Root.layout/Mobile/MobileSidebar";
import { Navbar } from "~/routes/pages/layouts/Root.layout/Mobile/Navbar";
import { type Taxon } from "~/routes/pages/layouts/Root.layout/types";
