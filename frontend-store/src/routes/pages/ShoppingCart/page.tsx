...
import type { CartItem } from "~/routes/pages/ShoppingCart/components/ShoppingCartContent";
import { ShoppingCartContent } from "~/routes/pages/ShoppingCart/components/ShoppingCartContent";
import { match } from "ts-pattern";
import { useAppStore } from "~/stores/stores";
import { createLazyRoute, Navigate, useNavigate } from "@tanstack/react-router";
import {
  useCartItemsInformation,
  useCustomerCartItems,
  useRemoveCartItem,
  useSetCartItemQuantity,
} from "~/routes/pages/ShoppingCart/api";

export const shoppingCartRoute = createLazyRoute("/cart")({
