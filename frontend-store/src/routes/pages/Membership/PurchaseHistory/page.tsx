...
import { IconShirt } from "~/routes/pages/common/Icons";
...
import {
  ...
  usePurchases,
} from "~/routes/pages/Membership/api";

export const purchaseHistoryRoute = createLazyRoute("/member/purchases")({
  component: PurchaseHistorySubpage,
});

function PurchaseHistorySubpage() {
